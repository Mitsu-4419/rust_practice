...
impl State {
    fn new() -> Self {
        ...
        resources.insert(TurnState::AwaitingInputs);
        Self {
            ecs,
            resources,
    ...
    fn game_over(&mut self, ctx: &mut BTerm){
        ...
        ctx.print_color_centered(8, YELLOW, BLACK, "Dont worry, you can always try again with a new hero.");
     ...
     fn reset_game_state(&mut self){
        ...
        self.resources.insert(TurnState::AwaitingInputs);
     }
...
impl GameState for State {
    fn tick(&mut self, ctx: &mut BTerm){
        ...
        match current_state {
            TurnState::AwaitingInputs => self.input_systems.execute(
                &mut self.ecs,
                &mut self.resources
            ),
